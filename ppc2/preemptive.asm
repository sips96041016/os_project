...
;	preemptive.c:38: do {
00106$:
;	preemptive.c:39: if(ID==MAXTHREADS-1) ID = 0;
	mov	r0,#_ID
	cjne	@r0,#0x03,00102$
	mov	r0,#_ID
	mov	@r0,#0x00
	sjmp	00103$
00102$:
;	preemptive.c:40: else ID++;
	mov	r0,#_ID
	inc	@r0
00103$:
;	preemptive.c:41: if(bitmap[ID]>0) break;
	mov	r0,#_ID
	mov	a,@r0
	add	a,#_bitmap
	mov	r1,a
...
;	preemptive.c:43: RESTORESTATE;
	...
	pop B 
	pop ACC 
;	preemptive.c:46: __endasm;
	reti
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'myTimer0Handler'
;------------------------------------------------------------
;	preemptive.c:49: void myTimer0Handler(void){
;	-----------------------------------------
;	 function myTimer0Handler
;	-----------------------------------------
_myTimer0Handler:
;	preemptive.c:50: SAVESTATE;
	push ACC 
	push B 
	push DPL 
	push DPH 
	...
	mov	r0,a
	mov	@r0,_SP
;	preemptive.c:51: temp1 = ID;
	mov	r0,#_ID
	mov	r1,#_temp1
	mov	a,@r0
	mov	@r1,a
;	preemptive.c:52: ID = manager_ID;
	mov	r0,#_manager_ID
	mov	r1,#_ID
	mov	a,@r0
	mov	@r1,a
;	preemptive.c:53: RESTORESTATE;
	mov	r0,#_ID
	mov	a,@r0
	add	a,#_ssp
	mov	r1,a
...
;	preemptive.c:87: temp2 = i<<3;
	...
	anl	a,#0xF8
	mov	@r1,a
;	preemptive.c:90: __endasm;
	push _temp2
;	preemptive.c:92: ssp[i] = SP;
	mov	r0,#_i
	mov	a,@r0
	add	a,#_ssp
	mov	r0,a
	mov	@r0,_SP
;	preemptive.c:93: SP = temp1;
	mov	r0,#_temp1
	mov	_SP,@r0
;	preemptive.c:94: EA = 1;
	setb	_EA
;	preemptive.c:95: return i;
	mov	r0,#_i
	mov	dpl,@r0
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	preemptive.c:98: void ThreadYield(void) {
;	-----------------------------------------
;	 function ThreadYield
;	-----------------------------------------
_ThreadYield:
;	preemptive.c:99: EA = 0;
	clr	_EA
;	preemptive.c:100: SAVESTATE;
	push ACC 
	push B 
	push DPL 
	push DPH 
...
;	preemptive.c:101: do {
00106$:
;	preemptive.c:102: if(ID==MAXTHREADS-1) ID = 0;
	mov	r0,#_ID
	cjne	@r0,#0x03,00102$
	mov	r0,#_ID
	mov	@r0,#0x00
	sjmp	00103$
00102$:
;	preemptive.c:103: else ID++;
	mov	r0,#_ID
	inc	@r0
00103$:
;	preemptive.c:104: if(bitmap[ID]>0) break;
	mov	r0,#_ID
	mov	a,@r0
	add	a,#_bitmap
	mov	r1,a
...
;	preemptive.c:113: do {
00106$:
;	preemptive.c:114: if(ID==MAXTHREADS-1) ID = 0;
	mov	r0,#_ID
	cjne	@r0,#0x03,00102$
	mov	r0,#_ID
	mov	@r0,#0x00
	sjmp	00103$
00102$:
;	preemptive.c:115: else ID++;
	mov	r0,#_ID
	inc	@r0
00103$:
;	preemptive.c:116: if(bitmap[ID]>0) break;
	mov	r0,#_ID
	mov	a,@r0
	add	a,#_bitmap
	mov	r1,a
